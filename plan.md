...
팀 공통 참고용. 요구사항 변경 및 우선순위 결정 이력입니다.

| 날짜 | 결정 내용 | 반영 문서 |
|---|---|---|
| 2026-04-08 | **주문 완료 후 플로우 순서 확정**: 주문 완료 → 인구통계 수집(즉시, FR-C06) → 5초 후 메뉴 리다이렉트 → 1분 후 별점 평가 모달(FR-C07) → 추천 모달(FR-C06, 메뉴 진입 1분 후 별도 타이밍) | `requirements.md` FR-C04, FR-C07 수정 |
